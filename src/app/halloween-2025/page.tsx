          ...
          >
            <div className="flex items-end gap-2 text-orange-50">
              <div className="text-center">
                ...
                <div className="text-2xl font-bold tabular-nums">{minutes}</div>
              </div>
        ...
        <div className="pointer-events-none fixed inset-0">
          <AnimatePresence>
            {spiders.map((s) => (
              <motion.button
                key={s.id}
                initial={{ scale: 0, rotate: (s.rotate ?? 0) - 10, opacity: 0 }}
                animate={{
                  scale: 1,
                  rotate: s.rotate ?? 0,
                  opacity: 1,
        ...
        {ended && (
          ...
          >
            <div className="mx-4 w-full max-w-md rounded-2xl border border-white/15 bg-black/60 p-8 backdrop-blur-md text-center">
              <div className="text-4xl md:text-5xl font-extrabold mb-2 bg-gradient-to-r from-amber-300 via-orange-400 to-rose-400 bg-clip-text text-transparent">
              ...
              {won && (
                <div className="text-sm md:text-base mb-6 text-orange-100/80 font-mono">
